...
class LiberoProEnv(gym.Env):
    ...
    def __init__(
        ...
        if self.obs_type == "state":
            raise NotImplementedError(
                "The 'state' observation type is not supported in LiberoProEnv. "
    ...
    def _format_raw_obs(self, raw_obs: RobotObservation) -> RobotObservation:
        ...
        raise NotImplementedError(
            f"The observation type '{self.obs_type}' is not supported in LiberoProEnv. "
            "Please switch to an image-based obs_type (e.g. 'pixels', 'pixels_agent_pos')."
        )
...
def _make_env_fns(
    *,
    ...
    control_mode: str,
) -> list[Callable[[], LiberoProEnv]]:
    """Build n_envs factory callables for a single (suite, task_id)."""

    def _make_env(episode_index: int, **kwargs) -> LiberoProEnv:
    ...
    fns: list[Callable[[], LiberoProEnv]] = []
